// Copyright (c) 2015-2016 The HSBC Core developers
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/HSBC/bitcoin/pull/6990)
